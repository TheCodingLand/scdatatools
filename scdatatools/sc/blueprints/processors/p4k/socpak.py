            ...
            for obj in ico.objects:
                if isinstance(obj, chunks.IncludedObjectType1):
                    ...
                    geom.add_instance(
                        ...
                        materials=materials, attrs=geom_attrs, soc=bpsoc
                    )
        except Exception as e:
            bp.log(f'Error processing chunk {ico_id} in soc {soc.soc_info.filename}', exc_info=e)
...
def process_socpak(bp: 'Blueprint', path: str, p4k_info: 'P4KInfo', bone_name='', attrs=None, *args, **kwargs) -> bool:
    """
