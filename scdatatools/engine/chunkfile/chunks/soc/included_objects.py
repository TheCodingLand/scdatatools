    ...
    def __init__(self, header, data, model):
        ...
        while len_objects > 0:
            ...
            if obj_class is None:
                ...
                if _last_known > 0:
                    logger.warning(f'SOC IncludedObject: Skipped block of {self.chunk_data.tell() - _last_known} bytes '
        ...
        if _last_known > 0:
            logger.debug(f'SOC IncludedObject: Skipped block of {self.chunk_data.tell() - _last_known} '
